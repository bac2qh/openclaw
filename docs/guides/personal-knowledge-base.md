...
- [Personal Knowledge Base with OpenClaw](#personal-knowledge-base-with-openclaw)
  - [Architecture Overview](#architecture-overview)
  - [Prerequisites](#prerequisites)
    - [Host Machine (M1 Pro Mac)](#host-machine-m1-pro-mac)
    - [VM Requirements](#vm-requirements)
    - [API Keys](#api-keys)
    - [Why Lume VM?](#why-lume-vm)
  - [Part 1: Host Setup (M1 Pro Mac)](#part-1-host-setup-m1-pro-mac)
    - [1.1 Install Lume](#11-install-lume)
    - [1.2 Install WhisperX](#12-install-whisperx)
    - [1.3 Create Transcription Script](#13-create-transcription-script)
    - [1.4 Create Shared Folders](#14-create-shared-folders)
    - [1.5 Optional: Auto-Transcribe with launchd](#15-optional-auto-transcribe-with-launchd)
    - [1.6 Test WhisperX](#16-test-whisperx)
  - [Part 2: Lume VM Setup](#part-2-lume-vm-setup)
    - [2.1 Create VM](#21-create-vm)
    - [2.2 Configure Shared Folder](#22-configure-shared-folder)
    - [2.3 Start and SSH into VM](#23-start-and-ssh-into-vm)
  - [Part 3: Install OpenClaw (Inside VM)](#part-3-install-openclaw-inside-vm)
    - [3.1 Install Prerequisites (Ubuntu)](#31-install-prerequisites-ubuntu)
    - [3.2 Install OpenClaw](#32-install-openclaw)
    - [3.3 Initialize Configuration](#33-initialize-configuration)
    - [3.4 Verify Shared Folder](#34-verify-shared-folder)
  - [Part 4: Configure Claude Sonnet 4 (Inside VM)](#part-4-configure-claude-sonnet-4-inside-vm)
    - [2.1 Get Anthropic API Access](#21-get-anthropic-api-access)
    - [2.2 Configure OpenClaw](#22-configure-openclaw)
  - [Part 5: Configure Memory Search (Inside VM)](#part-5-configure-memory-search-inside-vm)
    - [3.1 Enable Memory Search with Embeddings](#31-enable-memory-search-with-embeddings)
    - [3.2 Create Memory Workspace](#32-create-memory-workspace)
    - [5.3 Link Transcripts Folder to Memory](#53-link-transcripts-folder-to-memory)
  - [Part 6: Set Up Telegram Bot (Inside VM)](#part-6-set-up-telegram-bot-inside-vm)
    - [4.1 Create Telegram Bot](#41-create-telegram-bot)
    - [4.2 Configure Telegram Channel](#42-configure-telegram-channel)
    - [6.3 Configure Voice Transcription](#63-configure-voice-transcription)
      - [Option A: Use WhisperX Only (100% Free, Private)](#option-a-use-whisperx-only-100-free-private)
      - [Option B: Use API for Short Memos (Convenient, Small Cost)](#option-b-use-api-for-short-memos-convenient-small-cost)
  - [Part 7: Start OpenClaw Gateway (Inside VM)](#part-7-start-openclaw-gateway-inside-vm)
    - [5.1 Start the Gateway](#51-start-the-gateway)
    - [5.2 Verify Everything Works](#52-verify-everything-works)
    - [5.3 Test the Bot](#53-test-the-bot)
  - [Part 8: Daily Workflow](#part-8-daily-workflow)
    - [6.1 Voice Memos (Quick Notes)](#61-voice-memos-quick-notes)
    - [8.2 Meeting Recording (WhisperX on Host)](#82-meeting-recording-whisperx-on-host)
    - [6.3 Query Your Knowledge Base](#63-query-your-knowledge-base)
    - [6.4 Store Important Information](#64-store-important-information)
    - [6.5 Daily Review](#65-daily-review)
  - [Part 9: Set Up Reminders (Inside VM)](#part-9-set-up-reminders-inside-vm)
    - [7.1 Natural Language Reminders](#71-natural-language-reminders)
    - [7.2 Manage Reminders](#72-manage-reminders)
    - [7.3 Manual Reminder Setup (CLI)](#73-manual-reminder-setup-cli)
  - [Part 10: Configuration Reference](#part-10-configuration-reference)
    - [Full Configuration Example](#full-configuration-example)
    - [Key Configuration Paths](#key-configuration-paths)
    - [CLI Commands Reference](#cli-commands-reference)
  - [Part 11: Cost Summary](#part-11-cost-summary)
    - [Your Setup: Lume VM + WhisperX + Claude API](#your-setup-lume-vm--whisperx--claude-api)
    - [Alternative: Add Paid Transcription for Telegram Convenience](#alternative-add-paid-transcription-for-telegram-convenience)
    - [Transcription Accuracy Comparison](#transcription-accuracy-comparison)
  - [Part 12: Troubleshooting](#part-12-troubleshooting)
    - [Lume VM Issues](#lume-vm-issues)
    - [Bot not responding (Inside VM)](#bot-not-responding-inside-vm)
    - [WhisperX not transcribing (On Host)](#whisperx-not-transcribing-on-host)
    - [Telegram voice transcription not working (Inside VM)](#telegram-voice-transcription-not-working-inside-vm)
    - [Memory search not finding things](#memory-search-not-finding-things)
    - [Reminders not firing](#reminders-not-firing)
