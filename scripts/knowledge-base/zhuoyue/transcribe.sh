...
#
# Data flow:
#   - Short: Mac transcribes locally → saves to ~/openclaw/zhuoyue/transcripts/
#   - Long: Mac stages to NAS → sends WOL → GPU box worker transcribes → writes JSON to NAS output/
#   - sync.sh pulls completed JSONs from NAS → ~/openclaw/zhuoyue/transcripts/ → Google Drive
#
...
GDRIVE_TRANSCRIPTS="${HOME}/Google Drive/My Drive/openclaw/zhuoyue/transcripts"
GDRIVE_WORKSPACE="${HOME}/Google Drive/My Drive/openclaw/zhuoyue/workspace"
