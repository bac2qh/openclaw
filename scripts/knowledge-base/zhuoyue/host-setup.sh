...
#
# Usage: ~/openclaw/scripts/knowledge-base/zhuoyue/host-setup.sh
#
...
mkdir -p ~/Insync/bac2qh@gmail.com/Google\ Drive/openclaw/zhuoyue/workspace
mkdir -p ~/Insync/bac2qh@gmail.com/Google\ Drive/openclaw/zhuoyue/transcripts

# NAS (archival - audio only, staging for remote GPU)
echo "  Creating NAS folders..."
if [ -d /Volumes/NAS_1 ]; then
    mkdir -p /Volumes/NAS_1/zhuoyue/openclaw/media/recordings
    mkdir -p /Volumes/NAS_1/zhuoyue/openclaw/media/staging
    mkdir -p /Volumes/NAS_1/zhuoyue/openclaw/media/staging/output
    ...
    echo "    mkdir -p /Volumes/NAS_1/zhuoyue/openclaw/media/recordings"
    echo "    mkdir -p /Volumes/NAS_1/zhuoyue/openclaw/media/staging/output"
fi
...
echo "  ~/openclaw/scripts/knowledge-base/zhuoyue/transcribe.sh"
echo "  cat ~/Insync/bac2qh@gmail.com/Google\\ Drive/openclaw/zhuoyue/transcripts/*test*.json"
echo ""
echo "For auto-transcription, install the launchd plist:"
echo "  cp scripts/knowledge-base/zhuoyue/com.user.transcribe-zhuoyue.plist ~/Library/LaunchAgents/"
echo "  launchctl load ~/Library/LaunchAgents/com.user.transcribe-zhuoyue.plist"
echo ""
...
echo "     sudo visudo"
echo "     # Add: zhuoyue ALL=(ALL) NOPASSWD: /bin/systemctl suspend"
...
echo "   export REMOTE_USER=zhuoyue"
echo "   export REMOTE_SSH_PORT=22"
echo ""
echo "3. Test WOL and SSH:"
echo "   wakeonlan AA:BB:CC:DD:EE:FF"
echo "   sleep 30"
echo "   ssh zhuoyue@gpu-box 'docker run --rm --gpus all nvidia/cuda:12.0-base nvidia-smi'"
echo ""
